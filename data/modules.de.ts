    ...
    quiz: [
      {
        ...
        type: 'multi',
        options: ['Name und Adresse', 'Gesundheitsinformationen', 'Geburtsdatum', 'Fingerabdruck (biometrische Daten)', 'Religionszugehörigkeit'],
        correctIndexes: [1, 3, 4],
        explanation: 'Besonders schützenswert sind biometrische, gesundheitliche und weltanschauliche Daten gemäss Art. 5 DSG. Name, Adresse und Geburtsdatum sind normale Personendaten.',
      },
      {
        question: 'Was beinhaltet die Datenbearbeitung laut DSG?',
        type: 'multi',
        options: ['Beschaffung', 'Übermittlung', 'Archivierung', 'Aufbewahrung', 'Löschung'],
        correctIndexes: [0, 1, 2, 3, 4],
        explanation: 'Datenbearbeitung umfasst jeden Umgang mit Personendaten — von der Beschaffung bis zur endgültigen Löschung. Alles ist gemeint.',
      },
      {
        question: 'Was versteht man unter dem Grundsatz der Verhältnismässigkeit?',
        type: 'single',
        options: ['Alle verfügbaren Daten über eine Person sammeln', 'Nur so viele Daten bearbeiten, wie für den Zweck notwendig sind', 'Daten unbegrenzt lange aufbewahren'],
        correctIndexes: [1],
        explanation: 'Verhältnismässigkeit bedeutet Datenminimierung: Es dürfen nur so viele Daten erhoben und bearbeitet werden, wie für den konkreten Zweck tatsächlich erforderlich sind.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        type: 'multi',
        options: ['Firmen-E-Mail-Adresse', 'HIV-Status eines Mitarbeiters', 'Berufsbezeichnung', 'Fingerabdruckdaten für Zutrittskontrolle', 'Mitgliedschaft in einer Partei'],
        correctIndexes: [1, 3, 4],
        explanation: 'Gesundheitliche Daten (HIV-Status), biometrische Daten (Fingerabdruck) und politische Überzeugungen (Parteimitgliedschaft) sind besonders schützenswert. Firmen-E-Mail und Berufsbezeichnung sind normale Personendaten.',
      },
      {
        question: 'Wann liegt eine Datenschutzverletzung vor?',
        type: 'single',
        options: ['Wenn ein Mitarbeiter seinen Firmenlaptop mit nach Hause nimmt', 'Wenn Kundendaten unverschlüsselt per E-Mail versendet werden', 'Wenn Daten auf einem Unternehmensserver gespeichert werden'],
        correctIndexes: [1],
        explanation: 'Unverschlüsselte Übermittlung sensibler Kundendaten ist eine klassische Datenpanne. Laptop mit nach Hause nehmen oder Daten auf Unternehmensservern sind bei korrekter Handhabung kein Problem.',
      },
      {
        question: 'Eine IP-Adresse ist...',
        type: 'single',
        options: ['...kein Personendatum, da sie technisch ist', '...ein Personendatum, weil sie eine Person identifizierbar macht', '...nur dann ein Personendatum, wenn sie mit einem Namen verbunden ist'],
        correctIndexes: [1],
        explanation: 'IP-Adressen gelten grundsätzlich als Personendaten, weil sie in Kombination mit anderen Informationen (z.B. beim Provider) eine Person identifizierbar machen.',
      },
    ],
  },
  {
